        ...
        <div class="card my-5">
            <form action="{{ route('register') }}" method="POST" class="card-body cardbody-color p-lg-5">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-color px-5 mb-5 w-100 sendBtn">Register</button>
                </div>
                <div class="login-page-links">
                    <p class="mb-0 login-register">Already have an account?<a class="mx-1" href="{{ route('loginForm') }}">Login</a></p>
                </div>
            </form>
        </div>
    </div>
